...
from  database_V3_1 import SessionLocal, Usuarios, Categorias, Productos, Inventarios, Movimientos, Clientes, Proveedores, Ventas, Compras, Auditorias
...
def validar_sesion(db, usuario, contraseña, rol, estado):
    usuario = db.query(Usuarios).filter(Usuarios.usuario == usuario, Usuarios.contraseña == contraseña, Usuarios.rol == rol, Usuarios.estado == "Activo").first()
    return usuario
